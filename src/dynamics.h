...
struct Drift;
struct Drift * 
drift_alloc(size_t,int (*)(double,const double*,double*,double*,void*),
            void *);                                                
...
struct Diff;
struct Diff * 
diff_alloc(size_t, size_t,
           int (*)(double,const double*,double*,void*),
           void *);
void diff_free(struct Diff *);
int diff_eval(const struct Diff *,double,const double*,double*);
...
int dyn_eval(const struct Dyn *,double,const double*,double*,
             double*,double*);
